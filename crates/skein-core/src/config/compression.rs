...
pub struct CompressionConfig {
    ...
    #[serde(default)]
    pub compaction: crate::context_compression::CompressionLevel,
...
impl Default for CompressionConfig {
    fn default() -> Self {
        Self {
            ...
            compaction: crate::context_compression::CompressionLevel::default(),
            toon: false,
        }
    }
}
...
enabled = false
"#;
        let cfg: CompressionConfig = toml::from_str(toml_str).unwrap();
...
"#;
    ...
    fn toml_empty_uses_all_defaults() {
        let cfg: CompressionConfig = toml::from_str("").unwrap();
...
"#;
    ...
    fn default_compaction_is_safe() {
        let cfg = CompressionConfig::default();
        assert_eq!(cfg.compaction, crate::context_compression::CompressionLevel::Safe);
    }
    ...
    fn toml_compaction_level_override() {
        ...
        let cfg: CompressionConfig = toml::from_str(toml_str).unwrap();
        assert_eq!(cfg.compaction, crate::context_compression::CompressionLevel::Full);
    }
    ...
    fn toml_compaction_off() {
        ...
        let cfg: CompressionConfig = toml::from_str(toml_str).unwrap();
        assert_eq!(cfg.compaction, crate::context_compression::CompressionLevel::Off);
    }
