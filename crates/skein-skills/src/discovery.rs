...
/// Manages runtime discovery of `.skein/skills/` directories found in
...
impl RuntimeDiscovery {
    ...
    /// Discover `.skein/skills/` directories by walking up from each file path to `cwd`.
    ///
    ...
    /// already known not to contain a `.skein/skills/` subdirectory.
